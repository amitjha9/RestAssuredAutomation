...
public class TestPatchAPICall extends TestBase{
	...
	public void setUP()
	{
		try {
			...
			serviceURL=prop.getProperty("PATCH_URL");
			apiURL=prop.getProperty("PATCH_APIURL");
	...
	public void testPatchCall()
	{
		try {
			...
			requestParam.put("name", "Juli");
			requestParam.put("job", "Advocate");
			...
			Response response = httpRequest.request(Method.PATCH, URL);
