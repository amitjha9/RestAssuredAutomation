...
public class PostAPITestCase extends TestBase{
	...
	public void setUP()
	{
		try {
			...
			serviceURL=prop.getProperty("POST_URL");
			apiURL=prop.getProperty("POST_APIURL");
	...
	public void postCallImplementation()
	{
		try {
			...
			Assert.assertEquals(statusCode, statusCode_201OK);

			//Validate the status line
			String statusLine = response.getStatusLine();
			System.out.println("Status Line:" +statusLine);
			Assert.assertEquals(statusLine, status_Line_201OK);
